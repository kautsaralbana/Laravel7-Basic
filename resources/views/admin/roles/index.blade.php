        ...
        <table class="table table-hover">
            ...
            @foreach ($roles as $key => $role)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info" href="{{ route('admin.roles.show',$role->id) }}" disabled><i class="fa fa-eye"></i></a>
                        <a class="btn btn-warning" href="{{ route('admin.roles.edit',$role->id) }}"><i class="fa fa-edit"></i></a>
