        ...
        <div class="d-flex m-t-10 justify-content-end">
            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                ...
                <x-modal id="create" size="" color="primary" title="Create Data Sample">
                    <form class="form-material mt-4" action="{{ route('user.samples.store') }}" method="POST">
                        @csrf
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $sample->detail }}</td>
                    <td>
                        <form action="{{ route('user.samples.destroy', $sample->id) }}" method="POST">
                            <x-a-button class="warning" :href="route('user.samples.edit', $sample->id )">Edit</x-a-button>
                            @csrf
                            @method('DELETE')
